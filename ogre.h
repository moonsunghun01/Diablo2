...
public:
	...
	int getOgreDirection() { return _ogreDirection; }
	...
	image* getOgre() { return _ogre; }
	void setOgre(image* ogre) { _ogre = ogre; }

	image* getOgreShadow() { return _ogreShadow; }
	void setOgreShadow(image* ogreShadow) { _ogreShadow = ogreShadow; }

	RECT getOgreRc() { return _ogreRc; }
	void setOgremRc(RECT ogreRc) { _ogreRc = ogreRc; }

	RECT getOgreColRc() { return _ogreColRc; }
	void setOgreColRc(RECT ogreColRc) { _ogreColRc = ogreColRc; }
